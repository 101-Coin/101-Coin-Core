...
- [Building Bitcoin Green](#building-101coin)
...
```bash
    ...
    From https://github.com/101coin/101coin
...
For example:
```bash
URL=https://github.com/konez2k/101coin.git
...
[101coin/gitian.sigs](https://github.com/101coin/gitian.sigs/) repository, or if that's not possible to create a pull
request.
